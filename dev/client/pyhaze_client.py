...
def pyhazecl():
    ...
    if has_igl:
        ...
        res = pyhaze.smooth_pvd_adj(mesh_adj, pvd_data.tolist(), num_iter) # TODO: use with_nan and via_matrix
    else:
        res = pyhaze.smooth_pvd(vertices, faces, pvd_data.tolist(), num_iter) # TODO: use with_nan and via_matrix
